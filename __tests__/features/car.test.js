...
describe('Cars', () => {
    ...
    it('Should delete Car and return status code 204', async () => {
        ...
        const getIdUniqueCarInBD = await request(app).get('/api/v1/car/');
        
        const response = await request(app).delete(`/api/v1/car/${getIdUniqueCarInBD.body.veiculos[0]._id}`);
    ...
    it('Should reject Car delete and return error code 400 because this id was not found or it has already been deleted', async () => {
        ...
        await request(app).delete(`/api/v1/car/${getIdUniqueCarInBD.body.veiculos[0]._id}`);
    ...
    it('Should Car Get By Id and return status code 200', async () => {
        ...
        const response = await request(app).get(`/api/v1/car/${getIdUniqueCarInBD.body.veiculos[0]._id}`);
    ...
    it('Should reject Car Get By Id and return error code 404 because this id was not found', async () => {
        ...
        const response = await request(app).get(`/api/v1/car/${carId._id}`);
    ...
    it('Should Update a Car by ID and return status code 200', async () => {
        ...
        const getIdUniqueCarlInBD = await request(app).get('/api/v1/car/');
    ...
    it('Should reject User Update By Id and return error code 404 because this id was not found', async () => {
        ...
        const response = await request(app).put(`/api/v1/car/${carId._id}`).send(carUpdate);
    ...
    it('Should reject update a Acessory - Car by ID and return status code 200', async () => {
        ...
        const response = await request(app)
        .patch(`/api/v1/car/${getIdUniqueCarInBD.body.veiculos[0]._id}/acessorios/${getIdUniqueCarInBD.body.veiculos[0].acessorios[0]._id}`)
        .send(acessoryUpdate);
